...
### Módulo Especial de Conclusão de Curso de Engenharia de Software nas ESALQ
...
conda create --name insdeployai python=3.12

**Ative o ambiente:**

conda activate insdeployai (ou: source activate insdeployai)
...
streamlit run ins_app.py
nohup streamlit run ins_app.py --server.port=8501 --server.address=0.0.0.0 &
